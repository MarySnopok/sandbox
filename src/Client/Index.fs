...
type Model = { Todos: Todo list; Input: string; Animal: string; Name: string; NameInput: string }
...
let init () : Model * Cmd<Msg> =
    let model = { Todos = []; Input = ""; Animal = "Animals"; Name = "stranger"; NameInput = ""}
...
// possible animals
let animals = ["Dogs"; "Cats"; "Sheeps"; "Horses"; "Cows"]
...
let update (msg: Msg) (model: Model) : Model * Cmd<Msg> =
    ...
    | SetUserName  -> { model with Name = model.NameInput; NameInput = "" }, Cmd.none
